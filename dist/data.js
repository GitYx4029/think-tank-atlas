...
['CPI','气候政策倡议组织','Climate Policy Initiative','美国','旧金山',0,'金融与产业|气候与能源|国际发展|公共治理','以气候金融追踪、政策分析与金融创新为核心，覆盖减缓、适应、自然与公正转型。','climatepolicyinitiative.org',''],
...
['E3G','第三代环境主义','Third Generation Environmentalism','英国','伦敦',1,'气候与能源|金融与产业|外交与国际关系|治理与法治','专注气候外交、清洁能源转型、气候金融与韧性政策的国际倡议型智库。','e3g.org','about/'],
['Grantham','格兰瑟姆气候变化与环境研究所','Grantham Research Institute on Climate Change and the Environment','英国','伦敦',2,'气候与能源|金融与产业|经济与贸易|治理与法治|国际发展','LSE 旗下研究机构，聚焦气候经济、转型风险、金融体系、气候法与韧性。','lse.ac.uk/granthaminstitute',''],
...
Urban:'金融与产业|治理与法治|社会政策|健康|教育',WRI:'气候与能源|治理与法治|发展与人道主义',CPI:'金融与产业|气候与能源|发展与人道主义|治理与法治',
...
IFS:'经济与贸易|金融与产业|社会政策|健康|教育',IPPR:'经济与贸易|金融与产业|气候与能源|治理与法治|社会政策',E3G:'外交与国际关系|金融与产业|气候与能源|治理与法治|区域/国别研究',Grantham:'经济与贸易|金融与产业|气候与能源|治理与法治|发展与人道主义','ODI Global':'经济与贸易|气候与能源|治理与法治|发展与人道主义|区域/国别研究',Resolution:'经济与贸易|金融与产业|社会政策',
...
const R={
Brookings:'研究型|召集平台型|媒体传播型',CSIS:'研究型|召集平台型|媒体传播型',RAND:'研究型|合同研究/评估型|数据型',CFR:'研究型|召集平台型|媒体传播型',Carnegie:'研究型|召集平台型|人才网络型|媒体传播型',PIIE:'研究型|数据型|媒体传播型',Cato:'研究型|倡议型|媒体传播型',Heritage:'研究型|倡议型|媒体传播型',Urban:'研究型|合同研究/评估型|数据型',WRI:'研究型|倡议型|数据型|政策实验室/Do-tank|召集平台型',CPI:'研究型|数据型|政策实验室/Do-tank|召集平台型',
'Chatham House':'研究型|召集平台型|媒体传播型',IISS:'研究型|数据型|召集平台型|媒体传播型',RUSI:'研究型|召集平台型|媒体传播型',IFS:'研究型|数据型|媒体传播型',IPPR:'研究型|倡议型|政策实验室/Do-tank|媒体传播型',E3G:'研究型|倡议型|政策实验室/Do-tank|召集平台型|媒体传播型',Grantham:'研究型|数据型|培训能力建设型','ODI Global':'研究型|合同研究/评估型|数据型|培训能力建设型',Resolution:'研究型|倡议型|数据型|媒体传播型',
...
E3G:['慈善基金会、政府和非政府组织等资助方支持其研究与倡议工作。','https://www.e3g.org/about/funders/'],
Grantham:['2024—25 年新获研究资金约 3,589 万英镑：慈善信托与基金会约占 88%，政府／研究理事会约占 8%，企业及企业基金会约占 4%。','https://www.lse.ac.uk/granthaminstitute/wp-content/uploads/2026/02/GRI_Website_Funder_List_2024-25.pdf']};
const P={
Brookings:'中间派／建制派',CSIS:'跨党派／建制派',RAND:'中立／技术官僚型',CFR:'中间派／建制派',Carnegie:'中间派／自由国际主义',PIIE:'中立／市场开放取向',Cato:'自由意志主义／小政府',Heritage:'保守派／右翼',Urban:'中立／社会政策实证取向',WRI:'中立／绿色转型倡议',CPI:'中立／气候金融与政策实务取向',
'Chatham House':'中立／建制派国际主义',IISS:'中立／建制派安全政策',RUSI:'中立／建制派安全政策',IFS:'中立／技术官僚型',IPPR:'中间偏左／进步派',E3G:'绿色进步／气候政策倡议',Grantham:'中立／学术研究与政策转化','ODI Global':'中立／国际发展取向',Resolution:'中间偏左／社会民主取向',
...
const PD={
Brookings:'综合政策研究与跨党派影响力使其更接近美国中间派建制传统。',CSIS:'强调跨党派政策研究，风格偏务实的国家安全与战略政策咨询。',RAND:'以委托研究、量化方法和政策评估为主，通常不按党派定位。',CFR:'外交政策建制派平台，强调跨党派讨论与自由国际秩序。',Carnegie:'强调独立研究、外交与国际合作，整体呈自由国际主义风格。',PIIE:'强调非党派国际经济研究，政策上重视开放贸易与市场机制。',Cato:'以个人自由、有限政府、自由市场与和平为明确原则。',Heritage:'明确倡导美国保守主义公共政策。',Urban:'以数据和项目评估研究社会政策，机构自述为非党派。',WRI:'以科学研究推动气候、资源与可持续发展政策行动。',CPI:'机构自述为以金融和政策专业能力支持气候行动的分析与咨询机构，归类侧重其技术与实务导向。',
'Chatham House':'独立国际事务平台，风格接近英国外交政策建制与多边主义传统。',IISS:'以防务数据、战略评估和政策对话为核心，偏建制型安全研究。',RUSI:'英国国防安全政策传统浓厚，强调独立、实务型研究。',IFS:'以财政和社会政策的计量研究见长，风格偏技术官僚。',IPPR:'机构长期以进步主义公共政策研究定位。',E3G:'机构明确以推动气候行动的政治条件与政策方案为工作目标，属倡议和政策推动取向。',Grantham:'LSE 旗下跨学科研究机构，以气候与环境的学术研究、政策分析和培训为主，不作党派归类。','ODI Global':'强调独立研究与全球发展、人道政策，通常不作党派归类。',Resolution:'聚焦中低收入家庭、劳动与分配议题，常呈中间偏左政策取向。',
...
export const data=r.map((x,i)=>{let website=U+'www.'+x[8]+'/';return{id:i,short:x[0],name:x[1],full:x[2],country:x[3],city:x[4],region:x[3]==='美国'?'美国':x[3]==='英国'?'英国':'欧洲大陆',type:S[T[x[0]]??7],topics:(D[x[0]]||x[6]).split('|'),roles:(R[x[0]]||'研究型').split('|'),summary:x[7],website,source:U+'www.'+x[8]+'/'+x[9],funding:F[x[0]]?.[0]||'',fundingSource:F[x[0]]?.[1]||'',stance:P[x[0]],stanceNote:PD[x[0]],stanceSource:U+'www.'+x[8]+'/'+x[9],rss:'https://news.google.com/rss/search?q='+encodeURIComponent('site:'+x[8])+'&hl=en-US&gl=US&ceid=US:en'}});
