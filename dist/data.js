export const topics=['外交与安全','经济与贸易','公共治理','社会政策','气候与能源','科技与数字','国际发展','欧洲事务'];
const S=['独立研究机构','政策倡议机构','公共研究机构','学术研究机构','跨国智库网络'], U='https://';
const r=[
...
Bruegel:'中立／亲欧技术官僚型',CEPS:'中立／亲欧技术官僚型',ECFR:'自由国际主义／亲欧派',SWP:'中立／公共政策顾问型',DGAP:'中立／亲欧跨大西洋取向',ifo:'市场自由主义／中间偏右经济取向','Kiel Institute':'市场自由主义／中间派',Ifri:'中立／建制派国际主义',IDDRI:'绿色进步／可持续发展取向',SIPRI:'中立／和平与军控取向',PRIO:'中立／和平研究取向',HCSS:'中立／战略安全取向',Elcano:'中立／亲欧建制派',FIIA:'中立／公共政策研究型',NUPI:'中立／公共研究型',IAI:'中立／亲欧国际主义'};
const PD={
...
Bruegel:'以欧盟经济政策和技术分析为主，整体亲欧洲一体化。',CEPS:'面向欧盟制度与政策的独立研究，风格偏亲欧技术官僚。',ECFR:'泛欧洲外交政策网络，强调欧洲行动能力与自由国际主义。',SWP:'主要服务德国议会与政府决策，采用非党派政策顾问模式。',DGAP:'德国外交政策平台，整体重视欧洲合作与跨大西洋关系。',ifo:'经济研究强调市场机制、竞争与财政纪律。','Kiel Institute':'国际经济与贸易研究偏市场开放和规则导向。',Ifri:'法国独立国际事务研究，风格接近外交政策建制传统。',IDDRI:'以气候、生物多样性和可持续转型为中心，呈绿色进步取向。',SIPRI:'独立和平、安全与军控数据研究，通常不作左右划分。',PRIO:'学术型和平与冲突研究，通常不作党派归类。',HCSS:'战略与安全风险研究，风格偏实务和情景分析。',Elcano:'西班牙国际事务平台，整体重视欧洲一体化与多边合作。',FIIA:'受芬兰议会支持的独立研究机构，定位偏公共政策服务。',NUPI:'挪威公共研究机构，采用非党派学术研究取向。',IAI:'意大利国际事务研究，长期重视欧洲一体化与多边主义。'};
export const data=r.map((x,i)=>{let website=U+'www.'+x[8]+'/';return{id:i,short:x[0],name:x[1],full:x[2],country:x[3],city:x[4],region:x[3]==='美国'?'美国':x[3]==='英国'?'英国':'欧洲大陆',type:S[x[5]],topics:x[6].split('|'),summary:x[7],website,source:U+'www.'+x[8]+'/'+x[9],funding:F[x[0]]?.[0]||'',fundingSource:F[x[0]]?.[1]||'',stance:P[x[0]],stanceNote:PD[x[0]],stanceSource:U+'www.'+x[8]+'/'+x[9],rss:'https://news.google.com/rss/search?q='+encodeURIComponent('site:'+x[8])+'&hl=en-US&gl=US&ceid=US:en',verified:'2026-09-20'}});
